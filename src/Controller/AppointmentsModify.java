...
public class AppointmentsModify implements Initializable {
    ...
    public void sentAppointment(AppointmentModel AppointmentModel)
    {
        ...
        apptTitle.setText(String.valueOf(AppointmentModel.getTitle()));
        apptDesc.setText(String.valueOf(AppointmentModel.getDescription()));
        apptLoc.setText(String.valueOf(AppointmentModel.getLocation()));
        comboBoxApptContact.getSelectionModel().select(String.valueOf(AppointmentModel.getContactName()));
        comboBoxApptType.getSelectionModel().select(String.valueOf(AppointmentModel.getType()));
        datePickerApptStartDate.setValue(AppointmentModel.getStartDate());
        apptStartTime.setText(String.valueOf(AppointmentModel.getStartTimeString()));
        datePickerApptEndDate.setValue(AppointmentModel.getEndDate());
        apptEndTime.setText(String.valueOf(AppointmentModel.getEndTimeString()));
        comboBoxApptCustID.getSelectionModel().select(Integer.valueOf(AppointmentModel.getCustomerID()));
...
//            errorType = "Error in time input";
    ...
    void onActionModifyAppointment(ActionEvent event) throws IOException {
        ...
        if (!formattingErrors.isEmpty()) {
            ...
            alertConfirmAppointmentCreation.setContentText("Do you want to update this appointment with the following details? " + "\n" +
            ...
            if (result.get() == ButtonType.OK) {
                ...
                alertConfirmAppointmentIsAdded.setTitle("Update appointment");
                alertConfirmAppointmentIsAdded.setHeaderText("Update appointment");
                alertConfirmAppointmentIsAdded.setContentText("Appointment for " + customerName + " has been updated.");
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        currentApptID.setText(String.valueOf(AppointmentQuery.getHighestAppointmentID()));
    }
}
